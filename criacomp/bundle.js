...
window.encodingToMidiFile(document.getElementById("inbox").value, "download_inbox");
if (outbox1) {
  window.encodingToMidiFile(outbox1, "download_outbox1");
}

if (outbox2) {
  window.encodingToMidiFile(outbox2, "download_outbox2");  
}

if (outbox3) {
  window.encodingToMidiFile(outbox3, "download_outbox3");  
}

if (outbox4) {
  window.encodingToMidiFile(outbox4, "download_outbox4");  
}
